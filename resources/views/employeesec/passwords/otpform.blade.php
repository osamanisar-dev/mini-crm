        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    @if(Session::has('otp-send-success'))
                        <div class="alert alert-success">{{Session::get('otp-send-success')}}</div>
                    @elseif(Session::has('invalid-otp'))
                        <div class="alert alert-danger">{{Session::get('invalid-otp')}}</div>
                    @endif
